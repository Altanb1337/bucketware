...
namespace ENet.Managed.Native
{
    ...
    public static unsafe class LibENet
    {
        ...
        [UnmanagedFunctionPointer(ENetCallingConvention)]
        public delegate void HostEnableNewProtocolDelegate(Nullable<IntPtr> host, Nullable<int> state);
        public static HostEnableNewProtocolDelegate HostEnableNewProtocol;
